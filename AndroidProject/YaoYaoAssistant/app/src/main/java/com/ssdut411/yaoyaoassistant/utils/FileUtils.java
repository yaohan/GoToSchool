package com.ssdut411.yaoyaoassistant.utils;
...
public class FileUtils {
    ...
    public static String createFileOnSDCard(String path) {
        if (!SDCardUtils.isSDCardEnable()) {
            throw new com.ssdut411.yaoyaoassistant.exception.BaseException("SDCard不可用");
        }
        ...
        if (!file.exists()) {
            if (!file.mkdirs()) {
                throw new com.ssdut411.yaoyaoassistant.exception.BaseException("文件/文件夹" + path + "创建失败");
            }
        }
    ...
    public static void deleteFileOnSDCard(String path) {
        ...
        if (file.isFile() && file.exists()) {
            if (!file.delete()) {
                throw new com.ssdut411.yaoyaoassistant.exception.BaseException("删除文件" + path + "失败");
            }
        }
    }
     ...
     *
     * @param path 文件夹绝对路径
     * @throws com.ssdut411.yaoyaoassistant.exception.BaseException
     */
