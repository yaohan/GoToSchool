package com.ssdut411.app.bookbarstatic.widget;
...
public class ViewPagerIndicator extends LinearLayout {
    ...
    private static final int COLOR_TEXT_HIGHLIGHTCOLOR = R.color.font_black;    //选中颜色x
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawLine(0, -paintWidth / 2, getScreenWidth() / 3, -paintWidth / 2, mPaint);
        canvas.restore();
